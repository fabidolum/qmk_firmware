...
*/
  ...
  [LR_ASC_BEPO] = LAYOUT(
    ...
    _______,     KC_A,    KC_U,    KC_I,    KC_E, KC_COMM,       KC_BSPC,       KC_C,    KC_T,    KC_S,    KC_R,    KC_N,    KC_M,      KC_ENT,      KC_PGDN,
    CSA(SFT), CA_AGRV,    KC_Y,    KC_X,  KC_DOT,    KC_K,       KC_ENT,     CA_QUOT,    KC_Q,  	 KC_G,    KC_H,    KC_F, CA_CCED,            KC_UP,
  ...
  [LR_ASC_BEPO_SFT] = LAYOUT(
    _______,  _______, _______, _______, _______,   _______, _______, _______, _______,  _______, _______, _______, _______,         _______,          _______,
     KC_HASH,  M(M_1),  M(M_2),  M(M_3),  M(M_4),    M(M_5),                    M(M_6),   M(M_7),  M(M_8),  M(M_9),  M(M_0),  M(M_DEGR), M(M_GRV),     KC_BSPC,
    _______,  _______, _______, _______, _______,   _______,                   _______,  _______, _______, _______, _______,       KC_Z,  CA_CIRC, CA_BSLS, _______,
    _______,  _______, _______, _______, _______,   M(M_SCLN),      KC_BSPC,     _______,  _______, _______, _______, _______,       KC_M,       KC_ENT,      KC_PGDN,
    _______,  _______, _______, _______,  KC_COLN,   _______,      KC_ENT,      CA_QUES,  _______, _______, _______, _______,   CA_CCED,             KC_UP,
